OC.L10N.register(
    ...
    "You folder {source} has been converted to a PDF file. Please visit the details tab of the source folder to download the file." : "您的資料夾 {source} 已轉換為 PDF 檔案。請造訪原始資料夾的詳細資訊分頁以下載檔案。",
