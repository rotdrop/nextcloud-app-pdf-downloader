OC.L10N.register(
    ...
    "Internal error, \"%s\" is neither a plain file nor a directory." : "內部錯誤，「%s」不是普通檔案也不是目錄。",
    "\"%s\" could not be converted to PDF." : "「%s」無法轉換為 PDF。",
    "Internal error, \"%1$s\" is neither a plain file nor a directory, but has type \"%2$s." : "內部錯誤，「%1$s」不是普通檔案也不是目錄，但類型為「%2$s」。",
