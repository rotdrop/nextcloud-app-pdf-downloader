OC.L10N.register(
    ...
    "Choose a default PDF file destination folder in the cloud. Leave empty to use the parent directory of the folder which is converted to PDF:" : "在雲端中選擇一個預設的 PDF 檔案目的地資料夾。留空以使用轉換為 PDF 的資料夾的上層目錄：",
    "basename" : "基礎名稱",
    ...
    "The actions menu entry will then also appear for PDF files." : "對於 PDF 檔案，動作選單條目也會出現。",
