OC.L10N.register(
    ...
    "Your folder {source} has been converted to a PDF file." : "Your folder {source} has been converted to a PDF file.",
    "Please visit the details tab of the source folder {source} to download the file, or just click on the following link. The name of the download is {destination}. The download file will be removed automatically after some time, this purge-time can be configured in our personal preferences for this app." : "Please visit the details tab of the source folder {source} to download the file, or just click on the following link. The name of the download is {destination}. The download file will be removed automatically after some time, this purge-time can be configured in our personal preferences for this app.",
    ...
    "The temporary download file {destination} has been removed. Its creation time was: {timespan}." : "The temporary download file {destination} has been removed. Its creation time was: {timespan}.",
    ...
    "Cloud installation problem: instance ID is missing." : "Cloud installation problem: instance ID is missing.",
    "App-data root folder does not exist." : "App-data root folder does not exist.",
    "App-storage sub-folder \"%s\" does not exist and cannot be created." : "App-storage sub-folder \"%s\" does not exist and cannot be created.",
    "Unable to detect the archive format of \"%1$s\"." : "Unable to detect the archive format of \"%1$s\".",
    "Archive format of \"%1$s\" detected as \"%2$s\", but there is no backend driver installed which can decompress \".%3$s\" files." : "Archive format of \"%1$s\" detected as \"%2$s\", but there is no backend driver installed which can decompress \".%3$s\" files.",
    "Unable to deal with tar-files. Please check the installation of the app." : "Unable to deal with tar-files. Please check the installation of the app.",
    "The archive format of \"%1$s\" has been detected as \"%2$s\", but there is no backend driver installed which can deal with this format." : "The archive format of \"%1$s\" has been detected as \"%2$s\", but there is no backend driver installed which can deal with this format.",
    "The \"%1$s\" driver could handle this format, but it is not installed." : "The \"%1$s\" driver could handle this format, but it is not installed.",
    "Installation instructions:" : "Installation instructions:",
    "The \"%1$s\" driver claims to handle this format, but cannot extract the archive content." : "The \"%1$s\" driver claims to handle this format, but cannot extract the archive content.",
    ...
    "Shared folder for mount-point \"%1$s\" does not exist, cannot modify manager \"%2$s\"." : "Shared folder for mount-point \"%1$s\" does not exist, cannot modify manager \"%2$s\".",
    "Shared folder for mount-point \"%1$s\" does not exist, cannot set permissions for group \"%2$s\"." : "Shared folder for mount-point \"%1$s\" does not exist, cannot set permissions for group \"%2$s\".",
    "Shared folder for mount-point \"%1$s\" does not exist, cannot change its mount-point to \"%2$s\"." : "Shared folder for mount-point \"%1$s\" does not exist, cannot change its mount-point to \"%2$s\".",
    ...
    "Choose a folder requiring authentication" : "Choose a folder requiring authentication",
    "List of Dependencies" : "List of Dependencies",
    "List of required Dependencies" : "List of required Dependencies",
    ...
    "List of suggested Dependencies" : "List of suggested Dependencies",
    ...
    "Authenticated Background Jobs" : "Authenticated Background Jobs",
    "Use authenticated background jobs if necessary." : "Use authenticated background jobs if necessary.",
    "List of additional folders needing authentication" : "List of additional folders needing authentication",
    "Add a Folder" : "Add a Folder",
    "Subfolders are taken into account, you only need to specify the top-most folders." : "Subfolders are taken into account, you only need to specify the top-most folders.",
    ...
    "The font to use for the page labels: {font}" : "The font to use for the page labels: {font}",
    ...
    "The font to use for generated pages: {font}" : "The font to use for generated pages: {font}",
    ...
    "Optionally choose a default destination folder in the cloud. If left blank PDFs will be generated in the current directory." : "Optionally choose a default destination folder in the cloud. If left blank PDFs will be generated in the current directory.",
    ...
    "The actions menu entry will then also appear for non-archive files." : "The actions menu entry will then also appear for non-archive files.",
    ...
    "Move" : "Move",
    "Download of {fileName} failed: {message}." : "Download of {fileName} failed: {message}.",
    "Download of {fileName} failed." : "Download of {fileName} failed.",
    ...
    "Download of generated PDF failed: {message}." : "Download of generated PDF failed: {message}.",
    "Download of generated PDF failed." : "Download of generated PDF failed.",
    "Scheduled offline PDF generation to {path}." : "Scheduled offline PDF generation to {path}.",
    ...
    "Convert the entry into a PDF document." : "Convert the entry into a PDF document.",
    "PDF" : "PDF",
