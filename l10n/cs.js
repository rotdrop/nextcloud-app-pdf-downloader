OC.L10N.register(
    ...
    "Your folder {source} has been converted to a PDF file." : "Vaše složka {source} byla převedena do PDF souboru.",
    "Please visit the details tab of the source folder {source} to download the file, or just click on the following link. The name of the download is {destination}. The download file will be removed automatically after some time, this purge-time can be configured in our personal preferences for this app." : "Ohledně stažení souboru navštivte panel podrobností zdrojové složky {source}, nebo jen klikněte na následující odkaz. Název stahování je {destination}. Stažený soubor bude po nějaké době automaticky odebrán – tuto dobu je možné nastavit v osobních předvolbách pro tuto aplikaci.",
    ...
    "Unable to find any of the fallback converters \"%s\"." : "Nebylo možné najít žádné z náhradních nástrojů pro převod „%s“.",
    ...
    "App-storage sub-folder \"%s\" does not exist and cannot be created." : "Podsložka úložiště aplikace „%s“ neexistuje a nedaří se ji vytvořit.",
    ...
    "List of Dependencies" : "Seznam závislostí",
    "List of required Dependencies" : "Seznam požadovaných závislostí",
    ...
    "List of suggested Dependencies" : "Seznam doporučených závislostí",
    ...
    "The font to use for the page labels: {font}" : "Písmo pro popisky stránek: {font}",
    ...
    "The font to use for generated pages: {font}" : "Písmo které použít pro vytvářené stránky: {font}",
    ...
    "Purge Timeout" : "Časový limit vyčištění",
    ...
    "Move" : "Přesunout",
    "Download of {fileName} failed: {message}." : "Stahování {fileName} se nezdařilo: {message}",
    "Download of {fileName} failed." : "Stahování {fileName} se nezdařilo.",
    ...
    "Download of generated PDF failed: {message}." : "Stahování vytvořeného PDF se nezdařilo: {message}.",
    "Download of generated PDF failed." : "Stahování vytvořeného PDF se nezdařilo.",
