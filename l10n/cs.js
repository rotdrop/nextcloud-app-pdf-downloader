OC.L10N.register(
    ...
    "Uncompressed size of archive \"%1$s\" is too large: %2$d > %3$d" : "Nekomprimovaná velikost archivu „%1$s“ je příliš velká: %2$d > %3$d",
    "Archive \"%1$s\" is a potential zip bomp, size %2$d > %3$d" : "Archiv „%1$s“ je potenciální zip bomba, velikost %2$d > %3$d",
    ...
    "Test Input" : "Testovací zadání",
    "Test Hint" : "Testovací rada",
    ...
    "Administrative size limit: {archiveSizeLimit}" : "Administrativní limit velikosti: {archiveSizeLimit}",
    ...
    "Unable to query the initial value of {setting}: {message}" : "Nedaří se dotázat na úvodní hodnotu {setting}: {message}",
    "true" : "pravda",
    "Successfully set \"{setting}\" to {value}." : "„{setting}“ úspěšně nastaveno na {value}.",
    "Setting \"{setting}\" has been unset successfully." : "Nastavení „{setting}“ bylo úspěšně zrušeno.",
    "Unable to set \"{setting}\" to {value}: {message}." : "Nepodařilo se nastavit „{setting}„ na {value}: {message}.",
    "false" : "nepravda",
    "Unable to unset \"{setting}\": {message}" : "Nedaří se zrušit nastavení „{setting}“: {message}",
    "Confirmation Required" : "Je vyžadováno potvrzení",
    "Unconfirmed, reverting to old value." : "Nepotvrzeno – vrací se na původní hodnotu.",
    "Successfully set value for \"{settingsKey}\" to \"{value}\"" : "Úspěšně nastavena hodnota pro „{settingsKey}“ na „{value}",
