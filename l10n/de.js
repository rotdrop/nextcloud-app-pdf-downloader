OC.L10N.register(
    ...
    "\"%s\" is not a folder and archive extraction is disabled." : "\"%s\" ist kein Ordner und automatische entpacken von Archiv-Dateien ist deaktiviert.",
    ...
    "Unknown personal setting: \"%s\"." : "Unbekannte perönliche Einstellung: \"%s\"",
    ...
    "Installation problem; the required %s-resource \"%s\" is not installed on the server,\n please contact the system administrator!" : "Installationsproblem; die benötigte %s-Ressource \"%s\" ist auf dem Server nicht installiert, bitte den System-Administrator kontaktieren.",
