OC.L10N.register(
    ...
    "not found" : "找不到",
    "pass through" : "穿越",
    "Universal converter \"%1$s\" has failed trying to convert mime-type \"%2$s\"" : "通用轉換器「%1$s」嘗試轉換 mime-type「%2$s」失敗",
    "Converter \"%1$s\" has failed trying to convert mime-type \"%2$s\"" : "轉換器「%1$s」嘗試轉換 mime-type「%2$s」失敗",
    "Please install the \"%s\" program on the server." : "請在伺服器上安裝“%s”程序。",
    "Internal error, unknown file-system node-type: \"%s\"." : "內部錯誤，未知的檔案系統節點類型：「%s」。",
