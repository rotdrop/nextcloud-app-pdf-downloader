OC.L10N.register(
    ...
    "\"%s\" is not a folder and archive extraction is disabled." : "「%s」不是資料夾，封存檔解壓縮被停用。",
    "\"%s\" is not a folder and cannot be processed by archive extraction." : "「%s」不是資料夾，無法透過封存檔解壓縮處理。",
