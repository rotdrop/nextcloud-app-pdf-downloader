OC.L10N.register(
    ...
    "Choose a default PDF file destination folder in the cloud. Leave empty to use the parent directory of the folder which is converted to PDF:" : "在雲中選擇一個默認的 PDF 檔案目標文件夾。 保留為空以使用轉換為 PDF 的文件夾的父目錄：",
    "basename" : "基本名稱",
    ...
    "Enable conversion of individual files, other than archives or folders." : "啟用單個檔案的轉換，而不是封存檔案或資料夾。",
