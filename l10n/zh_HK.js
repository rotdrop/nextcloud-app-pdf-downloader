OC.L10N.register(
    "pdf_downloader",
    {
    "Post to end-point \"%s\" not implemented." : "到端點「%s」的 POST 未實作。",
    "Post to base-url of app \"%s\" not allowed." : "不允許到應用程式「%s」base-url 的 POST。",
    "Get from end-point \"%s\" not implemented." : "從端點「%s」的 GET 未實作。",
    "unknown" : "不詳",
    ...
    "Recusively convert entire directory trees to PDF and provide the resulting document as download" : "遞迴地將整個目錄樹轉換為 PDF 並提供生成的文檔以供下載",
    ...
    "Label output pages with file-name and page-number" : "使用檔案名稱與頁碼標記輸出頁面",
    ...
    "The font to use for the page-labels: {pageLabelsFont}" : "用於頁面註釋的字體：{pageLabelsFont}",
