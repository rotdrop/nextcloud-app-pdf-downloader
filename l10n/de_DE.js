OC.L10N.register(
    ...
    "Internal error, unknown file-system node-type: \"%s\"." : "Server-Fehler, unbekannter Dateisystem Eintrag: \"%s\".",
    ...
    "Font-sample could not be generated with \"%s\"." : "Schrift-Beispiel konnte nicht erstellt werden mit \"%s\".",
    ...
    "Font for generated PDF (error-)pages" : "Schriftart erzeugte PDF-(Fehler-)Seiten",
