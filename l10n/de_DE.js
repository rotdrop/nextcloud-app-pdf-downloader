OC.L10N.register(
    ...
    "\"%s\" is not a folder and cannot be processed by archive extraction." : "\"%s\" ist keine Ordner und kann nicht als Datei-Archiv extrahiert werden.",
    ...
    "Installation problem; the required %s-resource \"%s\" is not installed on the server,\n please contact the system administrator!" : "Installationsproblem; die benötigte %s-Ressource \"%s\" ist auf dem Server nicht installiert,\nbitte wenden Sie sich an die Administration!",
    ...
    "Recusively convert entire directory trees to PDF and provide the resulting document as download" : "Konvertiert ganze Verzeichnisbäume rekursiv in PDF und stellt das erstellte Dokument als Download bereit.",
    ...
    "converter chain" : "Kanvertierungskette",
    ...
    "Label output pages with file-name and page-number" : "Ausgabeseiten mit Dateiname und Seitenzahl versehen",
    "Format of the page-label: BASENAME_CURRENT_FILE PAGE/FILE_PAGES" : "Format der Seiten-Nummerierung:  BASENAME_CURRENT_FILE PAGE/FILE_PAGES",
