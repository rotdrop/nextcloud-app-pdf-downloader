OC.L10N.register(
    ...
    "Internal error, \"%s\" is neither a plain file nor a directory." : "Interner Fehler, \"%s\" ist weder eine einfache Datei noch ein Verzeichnis.",
    "\"%s\" could not be converted to PDF." : "\"%s\" konnte nicht in PDF umgewandelt werden.",
    "Internal error, \"%1$s\" is neither a plain file nor a directory, but has type \"%2$s." : "Interner Fehler. \"%1$s\" ist weder eine Klartextdatei noch ein Ordner, hat jedoch den Typ \"%2$s\".",
