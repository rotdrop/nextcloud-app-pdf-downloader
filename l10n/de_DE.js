OC.L10N.register(
    ...
    "You folder {source} has been converted to a PDF file. Please visit the details tab of the source folder to download the file." : "Ihr Ordner {source} wurde in eine PDF-Datei konvertiert. Bitte besuchen Sie den Details-Reiter des Quellordners, um die Datei herunterzuladen.",
    ...
    "Recursively convert entire directory trees to PDF and provide the resulting document as download" : "Konvertieren Sie ganze Verzeichnisbäume rekursiv in PDF und stellen Sie das resultierende Dokument als Download bereit",
