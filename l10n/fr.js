OC.L10N.register(
    ...
    "Post to base-url of app \"%s\" not allowed." : "Poster dans l'URL de base de l'application \"%s\" n'est pas autorisé.",
    "Get from end-point \"%s\" not implemented." : "Récupération depuis le point de montage \"%s\" non implémentée.",
    "unknown" : "Inconnu",
    ...
    "Installation problem; the required %s-resource \"%s\" is not installed on the server,\n please contact the system administrator!" : "Problème d'installation : la ressource nécessaire %s \"%s\" n'est pas installée sur le serveur, merci de contacter l'administrateur du système.",
    ...
    "Feedback email: {AutoReport}" : "Courriel pour les retours d'informtion : {AutoReport}",
    "Something went wrong." : "Quelque chose s'est mal passé.",
    "If it should be the case that you are already logged in for a long time without interacting with the web-app, then the reason for this error is probably a simple timeout." : "Si vous êtes connecté depuis longtemps sans interagir avec l'application, alors la raison de cette erreur est probablement un simple délai dépassé.",
    ...
    "Unrecoverable unknown internal error, no further information available, sorry." : "Erreur interne impossible à réparer, pas d'autre information disponible, désolé.",
