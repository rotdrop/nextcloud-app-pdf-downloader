OC.L10N.register(
    ...
    "The app will not work unless you install {program} such that it can be found by the web-server." : "Uygulama, {program} web sunucusu tarafından bulunabilecek şekilde kurulmadıkça çalışmaz.",
