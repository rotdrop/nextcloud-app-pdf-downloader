OC.L10N.register(
    ...
    "On-the-fly extraction of archive files. If enabled users can control this setting on a per-user basis." : "Arşiv dosyalarını anında ayıklar. Bu seçenek kullanıma alındığında, kullanıcılar bu ayarı kendileri için açıp kapatabilir.",
    ...
    "If checked default to background PDF generation. This can be overridden by navigating to the PDF panel in the details sidebar for each particular source folder or archive file." : "Bu seçenek kullanıma alındığında, PDF varsayılan olarak arka planda oluşturulur. Bu seçenek, her bir kaynak klasör ya da arşiv dosyası için ayrıntılar kenar çubuğundaki PDF panosuna giderek değiştirilebilir.",
    "Individual File Conversion" : "Bireysel dosya dönüşümü",
    "Enable conversion of individual files in addition to folders and archives." : "Bu seçenek kullanıma alındığında, klasörler ve arşivler dışında bireysel dosyaların dönüşümü yapılabilir.",
    ...
    "On-the-fly extraction of archive files is disabled by the administrator." : "Arşiv dosyalarının anında ayıklanması yönetici tarafından kullanımdan kaldırılmış.",
    ...
    "PDF files will also be decorated with page labels if page decoration is enabled." : "Sayfa dekorasyonu kullanıma alındığında, PDF dosyaları da sayfa etiketleriyle süslenir.",
