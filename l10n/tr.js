OC.L10N.register(
    ...
    "On-the-fly extraction of archive files. If enabled users can control this setting on a per-user basis." : "Arşiv dosyalarını anında ayıklar. Bu seçenek etkinse, kullanıcılar bu ayarı kendileri için açıp kapatabilir.",
    ...
    "PDF files will also be decorated with page labels if page decoration is enabled." : "Sayfa dekorasyonu etkinleştirildiğinde, PDF dosyaları da sayfa etiketleriyle süslenir.",
